          ...
          <div class="sticky-content">
            ...
            <div class="mobile_fixed-btn_wrapper">
              <div class="button-wrapper container">
                <a href="checkout.html" class="btn btn-primary btn-checkout">PROCEED TO CHECKOUT (COMING SOON)</a>
              </div>
            </div>
            {{-- paypal button --}}
            <div class="mobile_fixed-btn_wrapper text-center mt-1">
              <span>OR</span>
              <div class="button-wrapper container">
                <form action="{{ route('paypal') }}" method="post">
                  @csrf
                  <input type="hidden" name="price" value="{{ Cart::instance('cart')->total() }}">
                  <input type="hidden" name="product_name" value="1">
                  <input type="hidden" name="quantity" value="1">
                  <button type="submit" class="btn btn-warning btn-checkout">PAYPAL CHECKOUT</button>
              </form>
              </div>
            </div>
            {{-- end paypal button --}}
